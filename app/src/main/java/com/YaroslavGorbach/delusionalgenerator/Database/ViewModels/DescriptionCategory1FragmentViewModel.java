    ...
    public DescriptionCategory1FragmentViewModel(@NonNull Application application, int exId) {
        ...
        switch (exId){
            case 1:
                ...
                _exPeriod.setValue(application.getResources().getString(R.string.Period_exercise_1));
                break;
            case 2:
                ...
                _exPeriod.setValue(application.getResources().getString(R.string.Period_exercise_2));
                break;
            case 3:
                ...
                _exPeriod.setValue(application.getResources().getString(R.string.Period_exercise_3));
                break;
            case 4:
                ...
                _exPeriod.setValue(application.getResources().getString(R.string.Period_exercise_4));
                break;
            case 5:
                ...
                _exPeriod.setValue(application.getResources().getString(R.string.Period_exercise_5));
                break;
            case 6:
                ...
                _exPeriod.setValue(application.getResources().getString(R.string.Period_exercise_6));
                break;
            case 7:
                ...
                _exPeriod.setValue(application.getResources().getString(R.string.Period_exercise_7));
                break;
            case 8:
                ...
                _exPeriod.setValue(application.getResources().getString(R.string.Period_exercise_8));
                break;
            case 9:
                ...
                _exPeriod.setValue(application.getResources().getString(R.string.Period_exercise_9));
                break;
            case 10:
                ...
                _exPeriod.setValue(application.getResources().getString(R.string.Period_exercise_10));
                break;
            case 11:
                ...
                _exPeriod.setValue(application.getResources().getString(R.string.Period_exercise_11));
                break;
            case 12:
                ...
                _exPeriod.setValue(application.getResources().getString(R.string.Period_exercise_12));
                break;
            case 13:
                ...
                _exPeriod.setValue(application.getResources().getString(R.string.Period_exercise_13));
                break;
            case 14:
                ...
                _exPeriod.setValue(application.getResources().getString(R.string.Period_exercise_14));
                break;
        }
    }
}

...
public class Repo_SQLite extends SQLiteOpenHelper {

    public interface Listener{
        void onDataChange();
    }

    private static Repo_SQLite sInstance;
    public static Repo_SQLite getInstance(Context context){

        if (sInstance==null){
            sInstance = new Repo_SQLite(context);
        }
        return sInstance;
    }
    ...
    private Repo_SQLite(Context context){

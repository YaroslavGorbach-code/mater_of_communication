...
//
//            case 20:
//                mExName.setText("Существительные");
//                mAimOfExercise.setText(getResources().getString(R.string.Aim_of_exercise_20));
//                mHawToPerformTheExercise.setText(getResources().getString(R.string.Haw_to_perform_exercise_20));
//                break;
//
//            case 21:
//                mExName.setText("Прилагательные");
//                mAimOfExercise.setText(getResources().getString(R.string.Aim_of_exercise_21));
//                mHawToPerformTheExercise.setText(getResources().getString(R.string.Haw_to_perform_exercise_21));
//                break;
//
//            case 22:
//                mExName.setText("Глаголы");
//                mAimOfExercise.setText(getResources().getString(R.string.Aim_of_exercise_22));
//                mHawToPerformTheExercise.setText(getResources().getString(R.string.Haw_to_perform_exercise_22));
//                break;
//        }
//
//    }

package com.YaroslavGorbach.delusionalgenerator.screen.chartView.data;
...
public class Chart {
	...
	public static final int CHART_PARTS = 3;
	public static final int MAX_ITEMS_COUNT = 15;
	public static final int CHART_PART_VALUE = 100;

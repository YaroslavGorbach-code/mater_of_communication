...
public class RecordsView {
    ...
    public RecordsView(FragmentRecordsBinding binding, Callback callback, AdManagerImp adManagerImp) {

        // show Ad
        adManagerImp.showBanner(binding.getRoot().getContext(), binding.bannerContainer);
